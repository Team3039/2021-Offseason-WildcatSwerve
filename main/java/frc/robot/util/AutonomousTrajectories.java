...
public class AutonomousTrajectories {
    ...
    private static final String Test_AUTO_3 = "autos/TestAutos/TestAuto3.path";
    private static final String TEST_AUTO_ONE = "autos/TestAutos/TestAuto2.path";
    ...
    private Trajectory basicpath;
    private Trajectory testAuto1;
    private Trajectory testAuto3;
    ...
    public AutonomousTrajectories(TrajectoryConstraint[] trajectoryConstraints) throws IOException {
        ...
        testAuto1 = new Trajectory(getPath(TEST_AUTO_ONE), trajectoryConstraints, SAMPLE_DISTANCE);
        testAuto3 = new Trajectory(getPath(Test_AUTO_3), trajectoryConstraints, SAMPLE_DISTANCE);
    ...
    public Trajectory getTestAutoOne() {
        return testAuto1;
    }

    public Trajectory getTestAutoThree() {
        return testAuto3;
    }
    ...
    public Trajectory getBasicPath() {
        return basicpath;
    }
