...
public class VisionRotateToTargetCommand extends CommandBase {
    private static final PidConstants PID_CONSTANTS = new PidConstants(0.05, 0, 0); //(original) 0.5, 2.0, 0.025 //(far away) 0.005 0 0
    private static final double ROTATION_STATIC_CONSTANT = 0.3;
    private static  final double MAXIMUM_AVERAGE_VELOCITY = 1.0;
