...
public final class Constants {
    ...
    public static class DrivetrainCoefficients {
        ...
        public static final TrapezoidProfile.Constraints kThetaControllerConstraints = new TrapezoidProfile.Constraints(
                MotionConstraints.MAX_ANGULAR_VELOCITY_RADIANS_PER_SECOND,
                MotionConstraints.MAX_ANGULAR_ACCELERATION_RADIANS_PER_SECOND_SQUARED);
        ...
        public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(0.0); // FIXME
        public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(0.0); // FIXME
        public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(0.0); // FIXME
        public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(0.0); // FIXME
    }
}